        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1">
            <div className="relative">
                <img 
                src="https://picsum.photos/id/36/1200/1600" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col space-y-4">
                <div className="aspect-[4/3] rounded-3xl overflow-hidden bg-gray-100">
                    <img src="https://images.unsplash.com/photo-1545989253-02cc26577f88?q=80&w=800&auto=format&fit=crop" alt="Textures of Ecuador" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
                <h3 className="text-xl font-medium">Textures of Ecuador</h3>
                <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Quito Contemporary • 2022</p>
             ...
             <div className="flex flex-col space-y-4">
                <div className="aspect-[4/3] rounded-3xl overflow-hidden bg-gray-100">
                    <img src="https://images.unsplash.com/photo-1518173946687-a4c8892bbd9f?q=80&w=800&auto=format&fit=crop" alt="The World Unseen" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
                <h3 className="text-xl font-medium">The World Unseen</h3>
                <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Leica Gallery, Los Angeles • 2021</p>
                <p className="text-gray-600 leading-relaxed text-sm">
             ...
             <div className="flex flex-col space-y-4">
                <div className="aspect-[4/3] rounded-3xl overflow-hidden bg-gray-100">
                    <img src="https://images.unsplash.com/photo-1441974231531-c6227db76b6e?q=80&w=800&auto=format&fit=crop" alt="Silent Giants" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
                <h3 className="text-xl font-medium">Silent Giants</h3>
                <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Modern Arts, Miami • 2020</p>
                <p className="text-gray-600 leading-relaxed text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col space-y-4">
                <div className="aspect-[4/3] rounded-3xl overflow-hidden bg-white">
                    <img src="https://images.unsplash.com/photo-1505569127510-bde15360d7f6?q=80&w=800&auto=format&fit=crop" alt="Voices of the Wild" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
                <h3 className="text-xl font-medium">Voices of the Wild</h3>
                <p className="text-xs font-bold uppercase tracking-widest text-gray-400">National Geographic Fine Art • 2023</p>
                <p className="text-gray-600 leading-relaxed text-sm">
             ...
             <div className="flex flex-col space-y-4">
                <div className="aspect-[4/3] rounded-3xl overflow-hidden bg-white">
                    <img src="https://images.unsplash.com/photo-1469334031218-e382a71b716b?q=80&w=800&auto=format&fit=crop" alt="Future of Nature" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
                <h3 className="text-xl font-medium">Future of Nature</h3>
                <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Smithsonian, D.C. • 2022</p>
                <p className="text-gray-600 leading-relaxed text-sm">
             ...
             <div className="flex flex-col space-y-4">
                <div className="aspect-[4/3] rounded-3xl overflow-hidden bg-white">
                    <img src="https://images.unsplash.com/photo-1554907984-15263bfd63bd?q=80&w=800&auto=format&fit=crop" alt="Biophilia" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
                <h3 className="text-xl font-medium">Biophilia</h3>
                <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Fernbank Museum, Atlanta • 2020</p>
                <p className="text-gray-600 leading-relaxed text-sm">
      ...
      {/* 5. Awards & Accolades */}
       <section className="py-24 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="flex flex-col space-y-4">
                <div className="aspect-[4/3] rounded-3xl overflow-hidden bg-gray-100">
                    <img src="https://images.unsplash.com/photo-1628329352726-0a0e2840d244?q=80&w=800&auto=format&fit=crop" alt="Nature Photographer of the Year" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
                <h3 className="text-xl font-medium">Nature Photographer of the Year</h3>
                <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Finalist Selection • 2023</p>
                <p className="text-gray-600 leading-relaxed text-sm">
             ...
             <div className="flex flex-col space-y-4">
                <div className="aspect-[4/3] rounded-3xl overflow-hidden bg-gray-100">
                    <img src="https://images.unsplash.com/photo-1629814493399-53b92a394a4c?q=80&w=800&auto=format&fit=crop" alt="Canon Light & Shadow Grant" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
                <h3 className="text-xl font-medium">Canon Light & Shadow Grant</h3>
                <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Recipient • 2021</p>
                <p className="text-gray-600 leading-relaxed text-sm">
             ...
             <div className="flex flex-col space-y-4">
                <div className="aspect-[4/3] rounded-3xl overflow-hidden bg-gray-100">
                    <img src="https://images.unsplash.com/photo-1523906630133-06c36b4b32d1?q=80&w=800&auto=format&fit=crop" alt="Communication Arts Annual" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                </div>
                <h3 className="text-xl font-medium">Communication Arts Annual</h3>
                <p className="text-xs font-bold uppercase tracking-widest text-gray-400">Award of Excellence • 2020</p>
                <p className="text-gray-600 leading-relaxed text-sm">
