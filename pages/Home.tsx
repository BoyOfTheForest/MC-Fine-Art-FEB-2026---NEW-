  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-16 px-6 bg-white border-b border-gray-50">
        <Reveal className="max-w-7xl mx-auto text-center" delay={0}>
          ...
          <div className="flex flex-wrap justify-center gap-y-16 gap-x-12 items-center max-w-5xl mx-auto">
            {LOGO_DATA.map((logo, idx) => (
              <Reveal key={logo.name} delay={idx * 100} className="w-32 h-16 flex items-center justify-center grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-500 group">
                <img
                  src={logo.path}
                  alt={logo.name}
